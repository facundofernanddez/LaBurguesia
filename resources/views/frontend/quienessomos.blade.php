        ...
        <div class="col-md-7">
            <div id="carouselEmpleados" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4500">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <div class="position-relative">
                            <img src="{{ asset('img/chef.jpg') }}" class="d-block w-100 rounded-4 img-carrusel"
                                alt="Chef">
                            <div class="overlay">
                    ...
                    <div class="carousel-item">
                        <div class="position-relative">
                            <img src="{{ asset('img/subChef.jpg') }}" class="d-block w-100 rounded-4 img-carrusel"
                                alt="Cocinero">
                            <div class="overlay">
                    ...
                    <div class="carousel-item">
                        <div class="position-relative">
                            <img src="{{ asset('img/personal.jpg') }}" class="d-block w-100 rounded-4 img-carrusel"
                                alt="Camarero">
                            <div class="overlay">
                ...
                <div class="carousel-indicators">
                    <button type="button" data-bs-target="#carouselEmpleados" data-bs-slide-to="0" class="active"
                ...
                <!-- Flechas -->
                <button class="carousel-control-prev" type="button" data-bs-target="#carouselEmpleados"
                    data-bs-slide="prev">
                    <span class="carousel-control-prev-icon"></span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carouselEmpleados"
                    data-bs-slide="next">
